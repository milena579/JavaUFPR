...
// Crie uma estrutura de classes que represente diferentes tipos de Veículos. 
// A superclasse chama-se Veiculo. Esta possui três subclasses, VeiculoTerrestre,
// VeiculoAereo, VeiculoAquatico, que possuem, respectivamente, as subclasses Carro e
// Trem, Avião e Barco. 

//Crie atributos, getters e setters coerentes com a hierarquia. Toda a
...
public abstract class Veiculo {
    ...
    public Veiculo(String marca, String modelo, int anoFabricacao, int capacidadePassageiros) {
        this.marca = marca;
        this.modelo = modelo;
